...
public class carpaPrincipal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView texto6=(TextView) findViewById(R.id.id6);
        ...
        if (agno==2016 && mes==10 && dia==25&&dia<=28) {
            ...
            if (hora >= 16 && minuto >= 0 && hora < 19) {
                texto6.setTextColor(Color.GREEN);
            } else if (hora >= 19 ) {
                texto6.setTextColor(Color.RED);
            }
        }
